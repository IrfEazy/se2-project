...
\begin{table}[H]
    \begin{center}
        \begin{longtable}{ |l|p{0.5\linewidth}|l|l| }
            ...
            \hline
            SP\csp      & The EVD creates an account in eMALL system                                                                & EVD                 & eMALL             \\
            \hline
            ...
            \hline
            SP\csp      & eMALL gets the position of charging stations through eMSP's API                                           & eMALL               & eMSP              \\
            \hline
            SP\csp      & eMALL gets the costs of charging stations through eMSP's API                                              & eMALL               & eMSP              \\
            \hline
            SP\csp      & eMALL gets special offers active in close charging stations through eMSP's API & eMALL & eMSP\\
            \hline
            SP\csp      & eMALL gets information about the availability of charging points in a charging station through eMSP's API & eMALL & eMSP\\
            \hline
            SP\csp      & eMALL gets information about the plugs available in a charging station through eMSP's API & eMALL & eMSP\\
            \hline
            SP\csp      & The EVD retrieves information about the availability of charging points in a charging station & EVD & eMALL\\
            \hline
            SP\csp      & The EVD retrieves information about the availability of a specific plug in a charging station & EVD & eMALL\\
            \hline
            SP\csp      & The EVD books a charging point for a specific plug through eMALL                                          & EVD                 & eMALL             \\
            \hline
            SP\csp      & The EVD pays for a caution after booking a charge through eMALL                                           & EVD                 & eMALL             \\
            \hline
            SP\csp      & The EVD starts the charge and waits until the battery reaches the desired level of power & EVD & eMALL\\
            \hline
            SP\csp      & CPO inserts location information into the CPMS                                                            & EVD                 & eMALL             \\
            \hline
            SP\csp      & CPMS requests electricity to the DSO                                                                      & EVD                 & eMALL             \\
            \hline
            SP\csp      & The EVD inserts a new payment method and the required information into the system                                                                                                          & EVD                 & eMALL             \\
            \hline
            SP\csp      & eMALL returns the outcome of the validity of the payment method inserted by the EVD                                                                                                          & EVD                 & eMALL             \\
            \hline
            SP\csp      & eMALL returns the outcome of the payment done by the EVD                                                  & EVD                 & eMALL             \\
            \hline
            SP\csp      & eMALL notifies the user of the end of the charging process of his EV's battery                                                  & EVD                 & eMALL             \\
            \hline
        \end{longtable}
    \end{center}
