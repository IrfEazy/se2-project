...
%TODO: change the order of the flow: you start adding stations and then points. Update also the diagram
...
%TODO: update the state diagram following the use case
...
\begin{center}
%TODO: add other lines if you need them
    \begin{longtable}{ |l|p{0.9\linewidth}| }
        ...
        \hline
        DA\cda      & The \verb|eMALL| system communicates with a third-party entity which provides real-time EV's information through its API \\
        \hline
        DA\cda      & The \verb|eMALL| system communicates with DSOs through their APIs                                                        \\
        \hline
        DA\cda      & Charging points have their own software                                                                                  \\
        \hline
        DA\cda      & Communication between CPMSs and charging points happens through the OCPP protocol                                        \\
        \hline
